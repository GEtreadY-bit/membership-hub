...
export const mockInscricoes: Inscricao[] = [
  { id: '1', membro_id: '1', plano_id: '1', status: 'Em Atraso', dia_vencimento: 5, proximo_pagamento: '2026-03-05' },
  ...
  { id: '4', membro_id: '4', plano_id: '2', status: 'Em Atraso', dia_vencimento: 1, proximo_pagamento: '2026-03-01' },
  { id: '5', membro_id: '5', plano_id: '4', status: 'Ativo', dia_vencimento: 20, proximo_pagamento: '2026-04-20' },
  { id: '6', membro_id: '6', plano_id: '1', status: 'Em Atraso', dia_vencimento: 8, proximo_pagamento: '2026-03-08' },
];
